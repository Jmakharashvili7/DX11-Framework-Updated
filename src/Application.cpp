...
HRESULT Application::InitObjects()
{
    ...
    m_MainPlayerPawn = new PlayerPawn(OBJLoader::Load("3D_Models/Blender/MoonTest.obj", m_pd3dDevice));
...
void Application::Update()
{
    ...
    //if (m_MousePos->x < 0 || m_MousePos->x > m_WindowWidth)
    //{
    //    m_MouseClass.ResetMousePos(m_WindowWidth/2, m_WindowHeight/2);
    //}
    //
    //if (m_MousePos->y < 0 || m_MousePos->y > m_WindowHeight)
    //{
    //    m_MouseClass.ResetMousePos(m_WindowWidth/2, m_WindowHeight/2);
    //}
    // Update the camera
